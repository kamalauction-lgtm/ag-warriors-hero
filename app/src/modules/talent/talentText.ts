...
export const TL: Record<TLang, Text> = {
  en: {
    ...
    aboutYou: 'About you',
    fullName: 'Full name', preferredName: 'Preferred name', contact: 'Email address',
  ...
  'ms-MY': {
    ...
    fullName: 'Nama penuh', preferredName: 'Nama panggilan', contact: 'Alamat e-mel',
  ...
  'id-ID': {
    ...
    aboutYou: 'Tentang Anda',
    fullName: 'Nama lengkap', preferredName: 'Nama panggilan', contact: 'Alamat email',
